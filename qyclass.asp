...
<table style="margin-bottom:8px;" width="980" border="0" align="center" cellpadding="0" cellspacing="1" class="dq1">
  <tr>
    <td height="25" class="dq2" style="padding-left:6px;"> 地区导航：<a href="qyclass.asp?c=0,0,0&<%=T_ID%>">总站-></a></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" style="padding:8px;"><%=W_vassal_c_t(1,1,c1,c2,c3,t1,t2,t3,0,1,0,10,0,22)%></td>
  </tr>
</table>
</div>
...
<table style="margin-bottom:8px;" width="980" border="0" align="center" cellpadding="0" cellspacing="1" class="dq1">
  <tr>
    <td height="25" class="dq4" style="padding-left:6px;"><b>名 片 分 类</b> &nbsp;&nbsp;&nbsp;&nbsp;<a href="qyclass.asp?<%=C_ID%>&t=0,0,0">全部分类</a></td>
  </tr>
												<tr>
													<td colspan="4"><%=m_more(1,0,1,0,0,0,1,0,5,11,9,10,8)%></td>
												</tr>
												<tr>
													<td colspan="4"><HR></td>
												</tr>
												...
												<tr>
													<td colspan="4"><%=n_more(1,1,1,0,0,1,1,3,11,9,10,8)%></td>
												</tr>
</table>
...
<%=dq_more(0,0,0,1,15,3,1,1,13,10,18,0,0,0)%>
                </TD></TR>
</TBODY></TABLE></TD></TR>
</TBODY></TABLE>
...
<%=dq_more(0,0,0,1,15,2,0,2,11,10,18,1,0,0)%></TD></TR>
	...
	<TD width="760" valign="top"><table cellSpacing="0" cellPadding="0" width="760" border="0"  class="dq1">
			<tr>				
				<td align="middle" width="198"  height="30" class="dq4"><b>名 片 展 示</b></td>				
			</tr>
                  ...
                  <tr> 
                    <td height="23" valign="top"> 
                      ...
                      <tr onMouseOver="this.style.backgroundColor='#c5edfc';" onMouseOut="this.style.backgroundColor='#E6F7FF'"  class="dq2"> 
                          <td width="30%" height="20" class="F16">&nbsp;<b>企业名称</b></td>
                          <td width="35%" align="center"><b>地区</b></td>                          
                          <td width="25%" align="center"><b>加入时间</b></td>
                          <td width="10%" align="center"><b>点击</b></td>
                        </tr>
                        <tr>
...
'===================================
    ...
    sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
    end If'=========1=========
    
	if theitem<>"全部" and thecity="总站" then'=========2=========
	if type_oneid<>0 and type_twoid=0 and type_threeid=0 then 
    sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if type_oneid<>0 and type_twoid<>0 and type_threeid=0 then 
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if type_oneid<>0 and type_twoid<>0 and type_threeid<>0 then 
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and type_threeid="&type_threeid&"and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	end If'=========2=========
	
	if theitem="全部" and thecity<>"总站" then'=========3=========
	if city_oneid<>0 and city_twoid=0 and city_threeid=0 then 
    sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and city_oneid="&city_oneid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid=0 then 
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid<>0 then 
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and city_threeid="&city_threeid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	end If'=========3=========
	...
	if type_oneid<>0 and type_twoid=0 and type_threeid=0 then
	if city_oneid<>0 and city_twoid=0 and city_threeid=0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and city_oneid="&city_oneid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
    end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid=0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
    end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid<>0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and city_threeid="&city_threeid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
    end if
	end if
	
	if type_oneid<>0 and type_twoid<>0 and type_threeid=0 then
	if city_oneid<>0 and city_twoid=0 and city_threeid=0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and city_oneid="&city_oneid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid=0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid<>0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and city_threeid="&city_threeid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	end if
	
	if type_oneid<>0 and type_twoid<>0 and type_threeid<>0 then
	if city_oneid<>0 and city_twoid=0 and city_threeid=0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and type_threeid="&type_threeid&" and city_oneid="&city_oneid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid=0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and type_threeid="&type_threeid&" and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	if city_oneid<>0 and city_twoid<>0 and city_threeid<>0 then
	sqlqy="select * from DNJY_user where mpname Like '%"& searchname &"%' and type_oneid="&type_oneid&" and type_twoid="&type_twoid&" and type_threeid="&type_threeid&" and city_oneid="&city_oneid&" and city_twoid="&city_twoid&" and city_threeid="&city_threeid&" and mpkg=1 order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
	end if
	end if
	end if'=======================4============================

	if theitem="" and thecity="" then'=======================5============================
	sqlqy="select * from DNJY_user where mpname<>'' and mpkg=1"&tttt&""&ttccmp&" order by mpgd "&DN_OrderType&",id "&DN_OrderType&""
...
response.write "对不起，没有找到符合"&TempText&"条件的名片！"
else
...
if not rsqy.EOF then
	...
	intInfoCount = intInfoCount + 1%>
                        <tr onMouseOver="this.style.backgroundColor='#c5edfc';" onMouseOut="this.style.backgroundColor='#E6F7FF'" class="dq2"> 
                          <td width="30%" height="20" class="F16"><%if rsqy("vip")=1 then%>&nbsp;<img border="0" src="../images/vip.gif" alt="VIP会员"><%end if%><span style="font-size: 9pt">&nbsp;</span><a href="company.asp?username=<%=Cstr(rsqy("username"))%>&<%=T_ID%>&<%=C_ID%>" target="_blank" class="a01"><span style="font-size: 9pt"><% 
response.write Replace (rsqy("mpname"),searchname,"<font color=#FF0000>" & searchname & "</font>") 
%></span></a></td>
                          <td width="35%" align="center"><%qynavigate="<a href=""qyclass.asp?c="&rsqy("city_oneid")&",0,0"">"&rsqy("city_one")&"</a>"
	...
	response.write qynavigate%></td>                         
                          <td width="25%" align="center"><% =rsqy("dpdata")%></td>
                          <td width="10%" align="center"><% =rsqy("mphits")%></td>
                        </tr>
                        <tr>
						  <td width="100%" colspan="5" height="1" background="../images/dotline.gif"></td>
						</tr>
