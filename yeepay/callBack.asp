...
sql="select * from [DNJY_order] where ddhm='"&r6_Order&"' and cash="&r3_Amt&""
...
rs("ywje")=r3_Amt
rs("ywlx")="入帐"
rs("czbz")=""&r6_Order&" 订单金额入帐"
rs("czz")="在线支付"
rs("admincl")=1
rs("addTime")=now()
rs.update
Call CloseRs(rs)
conn.execute "UPDATE DNJY_user SET Amount=Amount+"&r3_Amt&" WHERE username='"&username&"'" '同时向用户更新帐户金额
Call CloseDB(conn)
'回写数据库支付状态end	
