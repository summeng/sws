...
dim b,bb,tj,xxsx,dick,ThisPage,tw,s
tw=request("tw")
If tw="" Or tw=1 Then
tw=1
s=10
...
<table width="980"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="220"><table width="100%"  border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;word-wrap:break-word;word-break:break-all">
      <tr>
        <td width="21"> <a href="<%if request.cookies("dick")("username")<>"" then %><%=adduserinfo%>?<%=CT_ID%><%Elseif addxinxi=1 then%><%=addinfo%>?<%=CT_ID%><%else%>level.asp?<%=CT_ID%><%End if%>"><img src="skin/ltby/addxx.jpg" width=190 height=52 border=0></a> </td>
      </tr>
    </table></td>
  </tr>
</table>
...
图例</span><font color="#008080">(<img border="0" src="images/num/pic.gif" width="13" height="13">-图片 <img border="0" src="images/num/jsq.gif" width="12" height="12">-置顶 <img border="0" src="images/jian.gif" width="15" height="15">-推荐 <img border="0" src="images/new.gif" >-最新)</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%If tw=1 Then%><A href="?xxsx=<%=xxsx%>&tw=2&<%=CT_ID%>"><font color="#0000ff"><b>简洁方式>>></b></font></A><%else%><A href="?xxsx=<%=xxsx%>&tw=1&<%=CT_ID%>"><font color="#0000ff"><b>详细方式>>></b></font></A><%End if%></td><td class="tablest2" height="26" colspan="1" align="right"><a href="rss.asp?<%=CT_ID%>" target="_blank"><img border="0" src="img/rss.gif" alt="订阅本分类的最新信息" width="31" height="15"></a></td></tr>                   
