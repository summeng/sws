   ...
   <td>
     <TABLE cellSpacing=0 cellPadding=0 width=740 border=0>
        ...
        <TR>
          ...
          <TD class=form-star>* </TD>
          <TD class=form-right><%=ddhm%><INPUT type="hidden" size=30 name=aliorder maxlength="200" value="<%=ddhm%>"></TD>
        </TR>
        <TR>
          <TD class=form-left>付款金额： </TD>
          <TD class=form-star>*</TD>
          <TD class=form-right><%=alimoney%> 元<INPUT type="hidden" maxLength=10 size=30 name=alimoney onfocus="if(Number(this.value)==0){this.value='';}" value="<%=alimoney%>"/>
            </TD>
        </TR>
        <TR>
          <TD class=form-left>备注：</TD>
          <TD class=form-star></TD>
          <TD class=form-right><TEXTAREA name=alibody rows=2 cols=40 wrap="physical"><%=hkuse%></TEXTAREA><BR>
