...
<%Dim out_trade_no,subject,body,price,logistics_fee,logistics_type,logistics_payment,quantity,receive_name,receive_address,receive_zip,receive_phone,receive_mobile,logistics_fee_1,logistics_type_1,logistics_payment_1,logistics_fee_2,logistics_type_2,logistics_payment_2,buyer_email,discount,para,sHtmlText
'''以下参数是需要通过下单时的订单数据传入进来获得'''
'必填参数
sTime=now()
'out_trade_no =year(sTime)&month(sTime)&day(sTime)&hour(sTime)&minute(sTime)&second(sTime)'请与贵网站订单系统中的唯一订单号匹配
out_trade_no =request.Form("aliorder")      '商家网站订单系统中的唯一订单号
...
receive_name		= request.Form("receive_name")			'收货人姓名，如：张三
receive_address		= request.Form("receive_address")			'收货人地址，如：XX省XXX市XXX区XXX路XXX小区XXX栋XXX单元XXX号
receive_zip			= request.Form("receive_zip")				'收货人邮编，如：123456
receive_phone		= request.Form("receive_phone")		'收货人电话号码，如：0571-88158090
receive_mobile		= request.Form("receive_mobile")			'收货人手机号码，如：13312341234
