...
if (mm < 10) hh+='0'
hh += mm
var str='<a href=../Include/calendar/ target=_blank>'+YYMMDD()+''+solarDay()+' '+weekday()+" <span id=ClockTime>"+hh+'</span></a>  <a href="javascript:clock()" target=_self  title=设置闹钟>闹钟</a>'
if(t==1) document.getElementById('rili').innerHTML=str
else document.write(str)}
function clock() {window.open('../Include/alarm_clock/','time','left='+(screen.width-320)+',height=310,width=305,status=no,toolbar=no,menubar=no')}
