...
<tr><a href="index.asp?<%=C_ID%>">返回首页</a> <td height="25"  align="center"><FONT  SIZE="3"><B>恭喜<font color=#FF6600><% =aliname %></font>，您已成功的提交了此订单！详细信息如下：</B></FONT></td></tr> 
<tr> <td height="18" >
...
<font color=red>本订单已同时发送一封Email到您的注册信箱中，请注意查收！</font>
<%end if%>
<p><font color="#999999">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<FONT COLOR="#000000">订单完成 
创建时间：<%=shijian%></FONT>&nbsp;</font></div></td></tr> </table>
</td></tr> </table>
<%dim welcome,mailbody,jmail
if trim(request.form("email"))<>"" then

welcome= "您在"&webname&"的订单"
mailbody = "恭喜您，您在【"&webname&"】成功确定"&hkuse&"订单！谢谢您的信任和支持，本站已进入处理订单程序！请及时按订单支付应付款，以免耽误时间。汇款后请登录本站→用户中心→我的订单→汇款确认。<br><b>您的订单信息：</b><br>订单号：<font color=#FF6600>"&ddhm&"</font><br>网站注册ID号：<font color=#FF6600>"&username&"</font><br>购买人：<font color=#FF6600>"&aliname&"</font><br>应付金额总计：<font color=red>"&alimoney&"</font>元。<br>详情请登录本站进入用户中心查询：<a href='"&web&"'>http://"&web&"</a>"
'邮件发送
