...
Call CloseRs(rs)
 ...
 return_url="http://"&web&"/"&strInstallDir&"tenpay/med/return_url.asp"         	         '显示支付结果页面,*替换成return_url.asp所在路径
 notify_url="http://"&web&"/"&strInstallDir&"tenpay/med/notify_url.asp"              		 '支付完成后的回调处理页面,*替换成notify_url.asp所在路径
%>