...
<%
dingdan=request("ddhm")'订单号码
product_name=request("hkuse")'支付项目（商品名称）
order_price=request("alimoney")'支付金额
...
<div align="center">
  ...
  <table width="760" height="406" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	function payFrm()
	{
		...
		if (directFrm.remarkexplain.value.length>21)
		{
...
%><%=dingdan%>
                      ...
                      <tr>
                        ...
                        <td valign="top"><span style="color:#000000;font-size:12px;">
                          <input name="product_name" type="text" size="18" maxlength="50" value="<%=product_name%>" >
                        </span></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">付款金额：</td>
                        <td valign="top"><%=order_price%> 
                        <!--input type="text" name="order_price" maxlength="50" size="18" onKeyUp="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" value=""--> 元（格式：500.01）</td>
						<input name="order_price" value="<%=order_price%>" type="hidden" size="18" maxlength="50"  />
                      </tr>
                      <tr>
                       <tr>
						<td align="right" valign="top">接口类型：</td>
						<td valign="top">
						<input type="hidden" name="trade_mode" maxlength="50" size="18"  value="1" />
                        ...
                        <td valign="top"><textarea name="remarkexplain" cols="48" rows="5" id="remark2" ><%=product_name%></textarea>
                          <br>
                          请填写您订单请填写您订单的简要说明（20字符以内）</td></tr>
                          <tr>
