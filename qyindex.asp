...
<table style="margin-bottom:8px;" width="980" border="0" align="center" cellpadding="0" cellspacing="1" class="dq1">
  <tr>
    <td height="25" class="dq2" style="padding-left:6px;"> 地区导航：<a href="qyindex.asp?c=0,0,0&<%=T_ID%>">总站-></a></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" style="padding:8px;"><%=W_vassal_c_t(1,0,c1,c2,c3,t1,t2,t3,0,1,0,10,0,22)%></td>
  </tr>
</table>
</div>
<div align="center">
<table border="0" width="980" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	<tr>
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0 class="dq1">
        ...
        <TR>
          <TD width="210" height=200 valign="top"><%=dq_more(0,0,0,1,10,3,1,1,13,10,18,0,0,0)%></TD></TR>
		  </table>
...
<TABLE cellSpacing=0 cellPadding=0 border=0 class="dq1">
        <TBODY>
        <TR><TD align=middle  class="dq4" height=30><b>点 击 热 门</b></TD></TR>
        <TR><TD width="210" height=200 valign="top"><%=dq_more(0,0,0,1,10,2,0,2,11,10,18,1,0,0)%></TD></TR>
</TBODY></TABLE>
</td>
      ...
      <TABLE borderColor=#0D81BC cellSpacing=0 cellPadding=0 border=0 width="760">
        ...
        <TR>
          <TD align=middle><!--开始--><table cellSpacing="0" cellPadding="0" width="760" border="0" class="dq1">
			<tr>				
				<td align="middle" width="114"  height="30" class="dq4"><b>名 片 分 类</b></td>				
			</tr>
...
<TABLE cellPadding=0 width=98% border=0>
              <TBODY>
              <TR align=left>
<%=m_more(1,0,1,1,0,0,1,0,3,11,9,10,8)%></TR>
...
<TABLE height=184 cellSpacing=0 cellPadding=0 width=980 align=center border=0 background="images/qyimg/qyls/product_bg.gif" >
<TBODY>
<TR>
<TD width=980 style="font-size: 12px; color: #000000; font-family: Verdana, Arial, Helvetica, sans-serif">
<TABLE>
<TBODY>
<TR><%=dq_more_dh(1,4,12,10,1,1,1,16,10,13,0,0,0)%>
</TR></TBODY></TABLE></TD>
