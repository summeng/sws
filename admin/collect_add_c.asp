...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  ...
  <tr class="tdbg"> 
    ...
    <td height="30"><a href="collect_add_a.asp">添加项目</a> >> <a href="collect_editor_a.asp?ItemID=<%=ItemID%>">基本设置</a> >> <a href="collect_editor_b.asp?ItemID=<%=ItemID%>">列表设置</a> >> <font color=red>链接设置</font> >> 正文设置 >> 采样测试 >> 属性设置 >> 完成</td>         
  </tr>         
</table>         
<br>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border" >
