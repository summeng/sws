...
Dim ItemID,ItemName,city_oneid,city_twoid,city_threeid,city_one,city_two,city_three,type_oneid,type_twoid,type_threeid,type_one,type_two,type_three,ListStr,ListPaingType,ListPaingStr2,ListPaingID1,ListPaingID2,ListPaingStr3,Flag,ItemCollecDate
Dim ListUrl
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  <tr class="tdbg"> 
    ...
    <td height="30"><a href=collect_start.asp>管理首页</a> | <a href="collect_add_a.asp">添加新项目</a></td>
  </tr>
</table>
<br>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border" >
    <tr> 
      <td height="22" colspan="2" class="title"> <div align="center"><b>信&nbsp;息&nbsp;采&nbsp;集</b></div></td>
    </tr>
</table>
<table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
<form name="myform" method="POST" action="collect_tion.asp">
        <TR>
...
SqlItem="select * from DNJY_xx_Item where Flag="&DN_True&" order by ItemID "&DN_OrderType&""         
 ...
 iItem=0
   ...
   %>
        <TR class="tdbg">
          ...
          <TD class="tdbg" align="center"><%=city_one&" "&city_two&" "&city_three%></TD>
          <TD class="tdbg" align="center"><%=type_one&" "&type_two&" "&type_three%></TD>
...
<%
Response.Write ShowPage("collect_start.asp",ItemNum,MaxPerPage,True,True," 个项目")
%>
