...
function UBBCode(Byval strContent)
	dim ImagePath
	dim emotImagePath
	ImagePath=cj_strInstallDir & "images/"
	emotImagePath=cj_strInstallDir & "guestbook/images/emot/"
	...
	strContent= re.Replace(strContent,"<br><IMG SRC="""&ImagePath&"$1.gif"" border=0> <a href="""& cj_strInstallDir & strChannelDir & "/$2"">点击浏览该文件</a>")
