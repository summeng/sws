...
Dim HistrolyID,ItemID,ItemName,ArticleID,NewsUrl,Result,city_oneid,city_twoid,city_threeid,city_one,city_two,city_three,type_oneid,type_twoid,type_threeid,type_one,type_two,type_three
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  <tr class='topbg'> 
    <td height="22" colspan="2" align="center" ><strong>信息采集系统历史记录管理</strong></td>
  </tr>
</table>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  <tr class="tdbg"> 
    <td width="65" height="30"><strong>管理导航：</strong></td>
    <td height="30"><a href=collect_record.asp>管理首页</a> </td>
  </tr>
</table>
<br>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="2" class="admintable">
  <tr>
    <td height="30" class="b1_1"><a href="collect_record.asp">管理首页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="collect_record.asp?Action=Succeed">成功记录</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="collect_record.asp?Action=Failure">失败记录</a></td>
  </tr>
</table>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border" >
    <tr> 
...
<table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
  <form name="myform" method="POST" action="collect_record.asp">
...
SqlItem="select HistrolyID,ItemID,ArticleID,Title,NewsUrl,Result,city_oneid,city_twoid,city_threeid,city_one,city_two,city_three,type_oneid,type_twoid,type_threeid,type_one,type_two,type_three from DNJY_xx_Histroly"
...
%>
    <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'" style="padding: 0px 2px;"  height="22">
	  ...
	  sql="select ItemName From DNJY_xx_Item Where ItemID="&ItemID&"" 
	  Rs.open Sql,conn,1,1
       ItemName=rs("ItemName")
		Response.Write ItemName
       Set Rs=Nothing%></td>
      <td width="300"><a href="http://<%=web%>/show.asp?id=<%=ArticleID%>" target="_bank"><%=Title%></a></td>
      <td width="170"><%=city_one%><%If city_two<>"" Then Response.Write " / "%><%=city_two%><%If city_three<>"" Then Response.Write " / "%><%=city_three%></td>
      <td width="170"><%=type_one%><%If type_two<>"" Then Response.Write " / "%><%=type_two%><%If type_three<>"" Then Response.Write " / "%><%=type_three%></td>
      ...
      <td width="30"> <a href=collect_record.asp?Action=Del&HistrolyID=<%=HistrolyID%> onClick='return confirm("确定要删除此记录吗？请您慎重选择！");'>删除</a></td>
    </tr>
    <%iItem=iItem+1
...
<%
Response.Write ShowPage("collect_record.asp",ItemNum,MaxPerPage,True,True," 个记录")
%>
...
If DelFlag="清除选中记录" Then
   ...
   Else
      HistrolyID=Replace(HistrolyID," ","")
      SqlItem="Delete From [DNJY_xx_Histroly] Where HistrolyID in(" & HistrolyID & ")"
   End If
ElseIf DelFlag="清除失败记录" Then
   SqlItem="Delete From [DNJY_xx_Histroly] Where Result="&DN_False&""
ElseIf DelFlag="清空所有记录" Then
   SqlItem="Delete From [DNJY_xx_Histroly]"
Else
   If HistrolyID="" Then
      FoundErr=True
      ErrMsg=ErrMsg & "<br><li>请选择要删除的记录</li>"
