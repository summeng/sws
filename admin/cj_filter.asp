...
<form method="post" action="cj_filter.asp" name="form1">                                
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border" >                                
    <tr>                                 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border" >                               
    <tr class="tdbg">                                
      <td colspan="2" align="center" class="tdbg">                               
        ...
        <input name="Cancel" type="button" id="Cancel" value="取&nbsp;&nbsp;消" onClick="window.location.href='cj_Settings.asp'" style="cursor: hand;background-color: #cccccc;">                             
...
If FoundErr<>True Then                                
   SqlItem ="select top 1 *  from DNJY_Article_Filters"                                
