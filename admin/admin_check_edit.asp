...
sql="select * from DNJY_wenda where id="&id
...
<title>修改问题和答案</title></head>
<body bgcolor="#FFFFFF" marginheight=0 marginwidth=0 leftmargin=0 background="../images/back.gif">
<link rel="stylesheet" type="text/css" href="../css/css.css">
<form name="form1" method="POST" action="admin_check_editsave.asp?id=<%=rs("id")%>" onsubmit="return FormCheck(this);">
<div align="center">
<center>
...
<font color="#F4FAFF"><input name="wenti" type="text" class="Input" value="<%=rs("wenti")%>" size="50">
</font> *</TD>
</TR>
<TR> 
...
<font color="#F4FAFF">
<input name="daan" type="text" class="input" value="<%=rs("daan")%>" size="50">
</font> *</TD>
</TR>
<tr>
