...
<form method="post" action="collect_modify.asp" name="form1">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border" >                                
    <tr>                                 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border" >
    <tr class="tdbg"> 
      <td colspan="2" align="center" class="tdbg">
        ...
        <input name="Cancel" type="button" id="Cancel" value="返&nbsp;&nbsp;回" onClick="window.location.href='collect_Settings.asp'" style="cursor: hand;background-color: #cccccc;">
        &nbsp;
...
If FoundErr<>True Then                                
   SqlItem ="select top 1 *  from DNJY_xx_Filters Where FilterID=" & FilterID                                
...
Sub Test
Set RsItem=server.createobject("adodb.recordset")         
SqlItem="select * from DNJY_xx_Filters Where FilterID=" & FilterID         
