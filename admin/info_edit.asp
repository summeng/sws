...
<div align="center">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
    <tr>
      <td width="100" valign="top" background="img/gggbg.jpg"><div align="center">
      </div></td>
      <td width="100%" align="center" valign="top"  bgcolor="#E3EBF9"><table width="795"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><form action="info_edit_save.asp" name="myform" method="POST" language="javascript" onSubmit="return formcheck()">
            <table width="100%" height="100%" border="0" align="right" cellpadding="6" cellspacing="0" bgcolor="#D6E0F9">
                
 <%dim biaoti,scjiage,jiage,memo,uname,name,tupian,email,dianhua,zt,CompPhone,youbian,dizhi,a,dqsj,hfje,homeEliteImage,sqljj,rsjj,Amount
id=trim(request("id"))
...
b=rs("b")
zt=rs("zt")
homeEliteImage=rs("homeEliteImage")

set rsjj=server.createobject("adodb.recordset")
sqljj = "select * from [DNJY_user] where username='"&uname&"'"
...
set rsjj=nothing%>              
                ...
                <tr>
                  <td height="25" align="right">交易地区：</td>
                  <td height="25" width="680">
<%
Dim rsi
...
set rsi = nothing%>
                  ...
                  <td height="25" align="right">信息类别：</td>
                  <td height="25">
<%set rsi=conn.execute("select * from DNJY_type where id>0 and twoid>0 and threeid=0")%>
                                 <SCRIPT language = "JavaScript">
var onecount2;
onecount2=0;
subcat2 = new Array();
...
%>
                ...
                <tr>
                  ...
                  <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" maxlength="30" name="biaoti" size="50" value="<%=biaoti%>">
          ...
          <select name="a" class="inputa">
            ...
            <option style="background: #000088" value="000088" <% if a="000088" Then Response.write("Selected") %>> </option>
            <option style="background: #0000ff" value="0000ff" <% if a="0000ff" Then Response.write("Selected") %>> </option>
            <option style="background: #008800" value="008800" <% if a="008800" Then Response.write("Selected") %>> </option>
            <option style="background: #008888" value="008888" <% if a="008888" Then Response.write("Selected") %>> </option>
            <option style="background: #0088ff" value="0088ff" <% if a="0088ff" Then Response.write("Selected") %>> </option>
            <option style="background: #00a010" value="00a010" <% if a="00a010" Then Response.write("Selected") %>> </option>
            <option style="background: #1100ff" value="1100ff" <% if a="1100ff" Then Response.write("Selected") %>> </option>
            <option style="background: #111111" value="111111" <% if a="111111" Then Response.write("Selected") %>> </option>
            <option style="background: #333333" value="333333" <% if a="333333" Then Response.write("Selected") %>> </option>
            <option style="background: #50b000" value="50b000" <% if a="50b000" Then Response.write("Selected") %>> </option>
            <option style="background: #880000" value="880000" <% if a="880000" Then Response.write("Selected") %>> </option>
            <option style="background: #8800ff" value="8800ff" <% if a="8800ff" Then Response.write("Selected") %>> </option>
            <option style="background: #888800" value="888800" <% if a="888800" Then Response.write("Selected") %>> </option>
            <option style="background: #888888" value="888888" <% if a="888888" Then Response.write("Selected") %>> </option>
            <option style="background: #8888ff" value="8888ff" <% if a="8888ff" Then Response.write("Selected") %>> </option>
            <option style="background: #aa00cc" value="aa00cc" <% if a="aa00cc" Then Response.write("Selected") %>> </option>
            <option style="background: #aaaa00" value="aaaa00" <% if a="aaaa00" Then Response.write("Selected") %>> </option>
            <option style="background: #ccaa00" value="ccaa00" <% if a="ccaa00" Then Response.write("Selected") %>> </option>
            <option style="background: #ff0000" value="ff0000" <% if a="ff0000" Then Response.write("Selected") %>> </option>
            <option style="background: #ff0088" value="ff0088" <% if a="ff0088" Then Response.write("Selected") %>> </option>
            <option style="background: #ff00ff" value="ff00ff" <% if a="ff00ff" Then Response.write("Selected") %>> </option>
            <option style="background: #ff8800" value="ff8800" <% if a="ff8800" Then Response.write("Selected") %>> </option>
            <option style="background: #ff0005" value="ff0005" <% if a="ff0005" Then Response.write("Selected") %>> </option>
            <option style="background: #ff88ff" value="ff88ff" <% if a="ff88ff" Then Response.write("Selected") %>> </option>
            <option style="background: #ee0005" value="ee0005" <% if a="ee0005" Then Response.write("Selected") %>> </option>
            <option style="background: #ee01ff" value="ee01ff" <% if a="ee01ff" Then Response.write("Selected") %>> </option>
            <option style="background: #3388aa" value="3388aa" <% if a="3388aa" Then Response.write("Selected") %>> </option>
            <option style="background: #000000" value="000000" <% if a="000000" Then Response.write("Selected") %>> </option>
          </select>
         
        </font></td>
                </tr>
                <tr>
                  <td height="25" align="right"> 关 键 词：</td>
                  <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" maxlength="100" name="keywords" size="50" value="<%=keywords%>"> <font color="#ff0000"> *</font> <input type="button" name="btn" value="从标题复制" title="复制标题到关键词" onClick="CopyWebbiaoti(document.myform.biaoti.value);">（<font color="#CC5200">100字节以内</font>）<br>（多个关键词用“,”号分隔）
					 </td>
                </tr>
                <tr>
                  <td height="25" align="right"> <font color='#0000FF'>首页头条：</font></td>
                  <td height="25"> <input name="homeEliteImage" type="text" id="homeEliteImage" value="<%=homeEliteImage%>" size="50" maxlength="255" readonly onclick="sHomeElite();">
                  <input name="isHomeElite" type="checkbox" id="isHomeElite" value="Yes" onClick="rHomeElite();" <%If homeEliteImage <> "" Then%> checked<%End if%>> <font color='#FF0000'>使用头条横幅（免费版无此功能）</font><br><span id="span_createImage"></span></td>
                </tr>
              <tr>
...
set rslx=nothing%>&nbsp;<font color="#ff0000"> *</font></td>
                ...
                <tr>
                  <td height="25" align="right">交易状态： </td>
                  <td height="25"><select name="zt" style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;">
     ...
     <tr> 
      <td height="25" align="right">信息主图：</td>
      <td colspan="2"><input name="tpname" type="text" class="input" id="tpname" size="50" maxlength="255" value="<%=tupian%>"> <font color="#CC5200">（也可在下面信息说明中提取内容第一张图片为主图）</font><br><iframe name="tpname" frameborder=0 width="450" height="35" scrolling=no src="../DNJY_upload.asp?ttup=info"></iframe><br>&nbsp;&nbsp;<font color="#ff0000">允许上传的文件类型：gif|jpgs|jpg|bmp|png 500k以下</font> </td>
    </tr>   

                <tr>
                  <td height="25" align="right"><p>信息说明：</td>
                  <td height="25"><textarea id="editor" name="memo" style="width:670px;height:400px;"><%=HTMLDecode(memo)%></textarea><input type="checkbox" name="T_SaveImg" value="1" /> 保存内容中远程图片到本地&nbsp;&nbsp;<input type="checkbox" name="AspJpeg" value="1" checked/>给上传图片加水印&nbsp;&nbsp;<input type="checkbox" name="T_conpic" value="1" />提取内容第一张图片为主图</td>
       </tr>
                <!--<tr>
                  <td height="25" align="right">外观颜色：</td>
                  <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" name="wcolor" size="23" maxlength="15" value="<%=rs("wcolor")%>"> &lt;=【<FONT color=blue><FONT 
      ...
      color=#993300>棕色</FONT></FONT>】</td>
                ...
                <tr>
                  ...
                  <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" name="ncolor" size="23" maxlength="15" value="<%=rs("ncolor")%>"> &lt;=【<FONT color=blue><FONT 
...
sj=DateDiff("d",""&fbsj&"",""&dqsj&"")%>
                     ...
                     <tr>
                        ...
                        <td  height="-1"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" name="hfje" size="23" value="0" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"> 元 （<span class="style1">此信息现有竞价余额<%=hfje%>元， 增加的金额将与余额相加。此会员资金帐户余额<%=Amount%>元</span>）</td>
                      </tr> 
                      <tr> 
                        <td height="25" align="right">信息置顶：</td>
                        <td height="0" >
                          <input type="text" name="b" size="23" maxlength="40" value="<%=b%>" style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                          级 （<span class="style1">置顶将在首页最新信息栏显示，数字越大排序越靠前</span>）</td>
                      </tr>					  
                      <tr> 
                        <td height="25" align="right">阅读权限：</td>
                        <td height="0" ><input type="radio" name="Readinfo" value="0" <%if Readinfo=0 then%>checked<%end if%>>游客	<input type="radio" name="Readinfo" value="1" <%if Readinfo=1 then%>checked<%end if%>>普通会员	<input type="radio" name="Readinfo" value="2" <%if Readinfo=2 then%>checked<%end if%>>VIP会员	
                             <br>（限制信息详细说明及联络方式，会员级别高向低兼容）</td>
                      </tr>
                      <!--<tr> 
                        <td height="25" align="right">阅读权限：</td>
                        <td height="0" ><input type="radio" name="Readinfo" value="1" <%if Readinfo=1 then%>checked<%end if%>>普通会员	<input type="radio" name="Readinfo" value="2" <%if Readinfo=2 then%>checked<%end if%>>VIP会员	
                             <br>（限制信息详细说明及联络方式，会员级别高向低兼容）</td>
                      </tr>-->							  
                      <tr> 
                        <td height="25" align="right">审核验证：</td>
                        <td height="0" >
                          <input type="radio" value="1" name="yz" <%if yz=1 then%>checked<%end if%> >立即通过</font><input type="radio" value="0" name="yz" <%if yz=0 then%>checked<%end if%> >暂不通过</td>
                      </tr>					
                <tr>
                  <td height="25" align="right">真实姓名：</td>
                  <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" name="name" size="23" maxlength="15" value="<%=name%>"> <font color="#ff0000"> *</font></td>
                </tr>


                       <tr>
                        <td height="25" align="right">移动电话：</td>
                        <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" name="CompPhone" size="23" maxlength="40" value="<%=CompPhone%>" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">  <font color="#0000ff"> *</font> （<font color="#CC5200">固定电话和移动电话必填其一</font>）</td>
                      </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" name="email" size="23" maxlength="40" value="<%=email%>">
                ...
                <tr>
                  ...
                  <td height="25"><input style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" type="text" name="weixin" size="23" maxlength="50" value="<%=rs("weixin")%>"></td>
                </tr>						  
                      <tr>
                      ...
                      <tr>
                        ...
                        <td height="25" width="371">
                            <input name="mpname" type="text" style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" size="50" maxlength="50" value="<%=rs("mpname")%>">
                          &nbsp; 
                          </td>
                      </tr>
                        <tr>
                        ...
                        <td height="25" width="371">
                            <input name="dizhi" type="text" style="BACKGROUND-COLOR: #ffffff; BORDER-BOTTOM: #FFFFFF 1px solid; BORDER-LEFT: #a2a2a2 1px solid; BORDER-RIGHT: #ffffff 1px solid; BORDER-TOP: #a2a2a2 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" size="50" maxlength="100" value="<%=dizhi%>">
                          &nbsp; 
                          </td>
                      </tr>
                ...
                </tr><input type="hidden" name="uname" value="<%=uname%>">
                <tr>
                  <td height="25" colspan="2" align="center"><table width="50%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><div align="center">
                            <input name="I2" type="submit" style="BACKGROUND-COLOR: #eeeeee; BORDER-BOTTOM: #a2a2a2 1px solid; BORDER-LEFT: #ffffff 1px solid; BORDER-RIGHT: #a2a2a2 1px solid; BORDER-TOP: #ffffff 1px solid; COLOR: #333333; FONT-SIZE: 9pt; HEIGHT: 19px;" onClick="javascript:return formcheck();" value="确认编辑" border="0">
                        </div></td>
                        <td><div align="center">
